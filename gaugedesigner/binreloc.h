...
/* Mangle symbol names to avoid symbol collisions with other ELF objects. */
	#define gbr_find_exe         Pkrs49030717801095_gbr_find_exe
	#define gbr_find_exe_dir     Pkrs49030717801095_gbr_find_exe_dir
	#define gbr_find_prefix      Pkrs49030717801095_gbr_find_prefix
	#define gbr_find_bin_dir     Pkrs49030717801095_gbr_find_bin_dir
	#define gbr_find_sbin_dir    Pkrs49030717801095_gbr_find_sbin_dir
	#define gbr_find_data_dir    Pkrs49030717801095_gbr_find_data_dir
	#define gbr_find_locale_dir  Pkrs49030717801095_gbr_find_locale_dir
	#define gbr_find_lib_dir     Pkrs49030717801095_gbr_find_lib_dir
	#define gbr_find_libexec_dir Pkrs49030717801095_gbr_find_libexec_dir
	#define gbr_find_etc_dir     Pkrs49030717801095_gbr_find_etc_dir
