...
extern          "C" {
	...
	/*!
	 \brief Create evaluator from string representing function.  Function
	...
	/*!
	 \brief Destroy evaluator specified.
	 */
	extern void     evaluator_destroy(void *evaluator);

	/*!
	 \brief Evaluate function represented by evaluator given.  Variable
	...
	/*!
	 \brief Return textual representation of function given by evaluator.
	...
	extern char    *evaluator_get_string(void *evaluator);
        ...
        /*!
	 \brief Get array of strings with names of variables appearing in
	...
	/*!
	 \brief Create evaluator for first derivative of function represented
	...
	/*
	 \brief Helper functions to simplify evaluation when variable names
	...
	/*
	 \brief Helper functions to simplify differentiation when variable
