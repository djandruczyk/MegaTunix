...
void build_constants_1(GtkWidget *parent_frame)
{
	...
	extern GList *interdep_widgets;
	extern GList *reqfuel_widgets;
	...
	interdep_widgets = g_list_append(interdep_widgets,(gpointer)label);
	reqfuel_widgets = g_list_append(reqfuel_widgets,(gpointer)label);
        gtk_misc_set_alignment(GTK_MISC(label),0.0,0.5);
