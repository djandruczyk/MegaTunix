...
#define DATALOG_YAML_DESCRIPTOIR_REQ_PKT_LEN 4
#define DATALOG_JSON_DESCRIPTOIR_REQ_PKT_LEN 4
...
typedef enum
{
	...
	/* Advanced datalog packets */
	REQUEST_JSON_DATALOG_DESCRIPTOR = 0x0300,
	RESPONSE_JSON_DATALOG_DESCRIPTOR,
	REQUEST_YAML_DATALOG_DESCRIPTOR,
	RESPONSE_YAML_DATALOG_DESCRIPTOR,
	REQUEST_SET_DATASTREAM_ID,
	RESPONSE_SET_DATASTREAM_ID,
	REQUEST_DEFINE_DATASTREAM_ID,
	RESPONSE_DEFINE_DATASTREAM_ID,
	REQUEST_LIST_OF_DATASTREAM_IDS,
	RESPONSE_LIST_OF_DATASTREAM_IDS,
