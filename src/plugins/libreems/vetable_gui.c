...
G_MODULE_EXPORT void common_draw_ve_marker(void)
{
	...
	locID = firmware->page_params[firmware->table_params[table]->x_page]->phys_ecu_page;
	...
	locID = firmware->page_params[firmware->table_params[table]->y_page]->phys_ecu_page;
