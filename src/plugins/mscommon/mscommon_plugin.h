...
/*!
  \file src/plugins/mscommon/mscommon_plugin.h
  \ingroup MSCommonPlugin,Headers
  \brief MSCommon plugin init/shutdown functions
...
EXTERN guint32 (*create_rtv_value_change_watch_f)(const gchar *, gboolean, const gchar *, gpointer);
...
EXTERN void (*remove_rtv_watch_f)(guint32);
