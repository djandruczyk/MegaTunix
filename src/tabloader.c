...
gboolean load_gui_tabs(void)
{
	...
	{
		glade_file = get_file(g_strconcat(GUI_DIR,PSEP,firmware->tab_list[i],NULL),g_strdup("glade"));
		map_file = get_file(g_strconcat(GUI_DIR,PSEP,firmware->tab_confs[i],NULL),g_strdup("datamap"));
