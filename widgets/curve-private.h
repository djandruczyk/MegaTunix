...
void generate_static_curve(MtxCurve *);
void update_curve(MtxCurve *);
void mtx_curve_init_colors(MtxCurve *);
void mtx_curve_redraw (MtxCurve *gauge, gboolean);
...
gboolean cancel_peak_wrapper(gpointer);
gboolean cancel_peak(gpointer);
gboolean auto_rescale_wrapper(gpointer );
gboolean auto_rescale(gpointer );
gboolean delay_turnoff_vertexes_wrapper(gpointer);
